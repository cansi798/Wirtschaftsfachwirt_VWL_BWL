...
\kopfzeile{Aufgabenheft VWL Lektion 1}

\begin{document}
\handouttitel{Aufgabenheft Lektion~1}%
  {Volkswirtschaftliche Grundbegriffe \& Preisbildung --- Übungen im IHK-Klausurformat}%
  {1.1 Volkswirtschaftliche Grundlagen}%
  {Selbstlernmaterial zur Lektion vom Mi, 19.08.2026}
...
erläutern, beurteilen, begründen) --- sie geben die geforderte Antworttiefe vor.
