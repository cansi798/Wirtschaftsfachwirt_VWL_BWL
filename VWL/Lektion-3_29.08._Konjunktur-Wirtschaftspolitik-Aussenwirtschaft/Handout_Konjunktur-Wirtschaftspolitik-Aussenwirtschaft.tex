...
\emph{harmonisierten Verbraucherpreisindex (HVPI)} soll unter, aber nahe zwei Prozent
liegen --- damit sind sowohl Inflation als auch Deflation ausgeschlossen. Die EZB
...
Grenzen: die \textbf{Schuldenbremse} im Grundgesetz (\S\,109 GG, seit 2009) und der
...
Freiheiten} des Binnenmarkts und die \emph{Konvergenzkriterien}. Wiederholen Sie außerdem
