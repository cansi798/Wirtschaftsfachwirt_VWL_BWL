...
beurteilen) --- sie geben die geforderte Antworttiefe vor. Erst danach öffnen Sie
...
Die Inflationsrate im Euroraum liegt deutlich über dem symmetrischen Inflationsziel der
...
gilt als erreicht, wenn der Anstieg des harmonisierten Verbraucherpreisindex (HVPI)
mittelfristig zwei Prozent beträgt (seit Juli 2021 ein \emph{symmetrisches}
Inflationsziel; zuvor: „unter, aber nahe zwei Prozent``) --- damit sind sowohl Inflation
als auch Deflation ausgeschlossen.
...
\textbf{(b)} \emph{Passiv:} Arbeitslosengeld I und Bürgergeld (bis 2022: ALG II), Kurzarbeitergeld,
...
Karteikarten der Lektionen 1--3. Nächster Termin: Start des BWL-Teils (Betriebliche Funktionen~I, Sa 24.10.2026).}
