...
\kopfzeile{Aufgabenheft VWL Lektion 2}

\begin{document}
\handouttitel{Aufgabenheft Lektion~2}%
  {Wettbewerbspolitik, Staatseingriffe \& VGR --- Übungen im IHK-Klausurformat}%
...
erläutern, berechnen, beurteilen, begründen) --- sie geben die geforderte
Antworttiefe vor. Zeichnen Sie bei den Diagramm-Aufgaben tatsächlich auf Papier ---
...
Bundeskartellamt angemeldet werden, das den Zusammenschluss untersagen kann, \emph{bevor}
...
gemessen an der Inflationsrate auf Basis des Verbraucherpreisindex (Ziel: Inflationsrate
von 2~\% --- symmetrisches Ziel der EZB seit 2021, HVPI); (2) \emph{hoher Beschäftigungsstand} --- gemessen an der Arbeitslosenquote (als
