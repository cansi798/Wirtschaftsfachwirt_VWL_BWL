...
\kopfzeile{BWL Lektion 2 \textperiodcentered{} Betriebliche Funktionen II}

\begin{document}
\handouttitel{Lektion~2: Betriebliche Funktionen II}%
  {Rechnungswesen, Finanzierung \& Investition, Controlling und Personal --- und wie alles zusammenwirkt}%
  {1.2 Betriebswirtschaftliche Grundlagen}%
  {Sa, 12.09.2026, 08:15--13:15 Uhr}
