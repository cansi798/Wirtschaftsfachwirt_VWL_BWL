...
\title{\vspace*{-1.5cm}\Huge\bfseries\color{bfwPrimaryDark}Aufgabenheft Lektion~1 (BWL)\\[0.4em]
  \large\color{bfwInkSoft}\textnormal{Betriebliche Funktionen I: Produktion, Logistik \& Marketing --- Übungen im IHK-Klausurformat}}
