...
\kopfzeile{BWL Lektion 4 \textperiodcentered{} Unternehmenszusammenschlüsse}

\begin{document}
\handouttitel{Lektion~4: Unternehmenszusammenschlüsse}%
  {Von der Kooperation zur Konzentration --- und wo das Kartellrecht Grenzen zieht}%
  {Betriebswirtschaftliche Grundlagen}%
  {Sa, 27.02.2027, 08:15--13:15 Uhr}
...
Für diese Lektion genügen drei einfache Rechnungen. Prägen Sie sich jeweils Formel,
...
\subsection{Synergieeffekt (Kosten vor und nach der Fusion)}
...
\emph{Richtungen} mit Praxisbeispielen, \emph{Kartellverbot} (\S\,1 GWB) und
\emph{Fusionskontrolle} (Bundeskartellamt/EU-Kommission) sowie die drei
\emph{Rechenwege} (Marktanteil, Beteiligungsquote, Synergieeffekt). Üben Sie mit dem
Aufgabenheft, dem Quiz und den Übungen 54--58 des Übungsbands!
\end{merksatz}
