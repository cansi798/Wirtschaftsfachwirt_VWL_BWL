...
\kopfzeile{Aufgabenheft BWL Lektion 4}

\begin{document}
\handouttitel{Aufgabenheft Lektion~4 (BWL)}%
  {Unternehmenszusammenschlüsse --- Übungen im IHK-Klausurformat}%
  {Betriebswirtschaftliche Grundlagen}%
  {Selbstlernmaterial zur Lektion vom Sa, 27.02.2027}
